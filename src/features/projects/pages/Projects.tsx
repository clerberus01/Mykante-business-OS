...
import { useSupabaseProjects as useProjects } from '@/src/hooks/supabase';
...
export default function Projects() {
  ...
  const routeSearch = useRouterState({
    select: (state) => state.location.search as { projectId?: string; action?: string },
  });
  ...
  React.useEffect(() => {
    ...
    if (routeSearch.action === 'create-project') {
  ...
  }, [navigate, routeSearch.action, routeSearch.projectId]);
